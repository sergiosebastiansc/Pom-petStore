...
- Location: tests\pago.spec.js:33:9
...
- generic [ref=f3e3]:
  - banner [ref=f3e4]:
    - link "Pet Store" [ref=f3e5] [cursor=pointer]:
      - /url: /
  - main [ref=f3e10]:
    - generic [ref=f3e11]:
      - heading "Bienvenido de nuevo" [level=1] [ref=f3e12]
      - paragraph [ref=f3e13]: Ingresa a tu cuenta de Pet Store
      - generic [ref=f3e14]:
        - generic [ref=f3e15]:
          - generic [ref=f3e16]: Correo electrónico
          - generic [ref=f3e17]:
            - generic [ref=f3e18]: email
            - textbox "tu@correo.com" [ref=f3e19]
        - generic [ref=f3e20]:
          - generic [ref=f3e21]: Contraseña
          - generic [ref=f3e22]:
            - generic [ref=f3e23]: lock
            - textbox "••••••••" [ref=f3e24]
            - button "visibility" [ref=f3e25] [cursor=pointer]
          - link "¿Olvidaste tu contraseña?" [ref=f3e28] [cursor=pointer]:
            - /url: /login
        - button "Iniciar Sesión" [ref=f3e29] [cursor=pointer]
      - paragraph [ref=f3e30]:
        - text: ¿No tienes cuenta?
        - link "Regístrate" [ref=f3e31] [cursor=pointer]:
          - /url: /registro
  - contentinfo [ref=f3e32]:
    - link "Privacidad" [ref=f3e33] [cursor=pointer]:
      - /url: /login
    - link "Términos" [ref=f3e34] [cursor=pointer]:
      - /url: /login
    - link "Contacto" [ref=f3e35] [cursor=pointer]:
      - /url: /login
    - link "Preguntas Frecuentes" [ref=f3e36] [cursor=pointer]:
      - /url: /login
```
