...
Locator: getByText('El número de tarjeta está incompleto.', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('El número de tarjeta está incompleto.', { exact: true })
...
- main:
  ...
  - iframe
  - text: error
  - paragraph: Your card number is incomplete.
