...
- main:
  ...
  - textbox "Juan García": Sergio SSCX
  - text: Correo electrónico email
  - textbox "tu@correo.com": sergiosebastianxx@gmail.com
...
```ts
  ...
  16 |         await registerPage.registro ('Sergio SSCX', 'sergiosebastianxx@gmail.com','clave1234', 'clave1234')
