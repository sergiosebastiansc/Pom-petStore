...
```yaml
- text: error El correo ya está registrado
- banner:
  - link "Pet Store":
    - /url: /
    - img
...
- main:
  ...
  - textbox "Juan García": Sergio Salinas SC
  - text: Correo electrónico email
  - textbox "tu@correo.com": sergiosebastianscxx@gmail.com
...
```ts
  ...
  16 |         await registerPage.registro ('Sergio Salinas SC', 'sergiosebastianscxx@gmail.com','clave1234', 'clave1234')
