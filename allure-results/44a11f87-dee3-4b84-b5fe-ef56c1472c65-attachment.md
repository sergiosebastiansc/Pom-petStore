...
- Name: registro.spec.js >> validando registro de cuenta >> Registro de una cuenta ya creada
- Location: tests\registro.spec.js:20:9
...
Locator: getByText('El correo ya está registrado', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('El correo ya está registrado', { exact: true })
...
- main:
  ...
  - link "Política de Privacidad":
    - /url: /registro
  - button "Creando cuenta..." [disabled]
  - paragraph:
...
```ts
  ...
  15 |         //en caso de usuario 
  16 |         await registerPage.registro ('Sergio Salinas', 'sergiosebastiansc@gmail.com','clave1234', 'clave1234')
